...
def get_unique_motivation():
    ...
    for attempt in range(3):
        ...
        try:
            ...
            prompt = "Generate exactly ONE brutal, punchy motivation or tips line for study. Max 12 words. Raw energy, no fluff. Hinglish allowed. No hashtags, no quotes,emojis. Output ONLY the line."
